...
public class InitDataUtils {
    ...
    public static void main(String[] args) {
        ...
        userList.add(new User(1, "李逍遥", "正常", new BigDecimal(("101")), Constant.USER_LEND_NO));
        userList.add(new User(2, "酒剑仙", "正常", new BigDecimal(("1")), Constant.USER_LEND_NO));
        userList.add(new User(3, "拜月教主", "正常", new BigDecimal(("10000000")), Constant.USER_LEND_NO));
        userList.add(new User(4, "阿七", "正常", new BigDecimal(("100000")), Constant.USER_LEND_NO));
        userList.add(new User(5, "唐钰小宝", "正常", new BigDecimal(("500000")), Constant.USER_LEND_NO));
        userList.add(new User(6, "李大婶", "正常", new BigDecimal(("500000")), Constant.USER_LEND_NO));
        userList.add(new User(7, "圣姑", "正常", new BigDecimal(("500000")), Constant.USER_LEND_NO));
        userList.add(new User(8, "王小虎", "正常", new BigDecimal(("500000")), Constant.USER_LEND_NO));
        initData(userList, Constant.USER_DATA_DIR, Constant.USER_DATA_FILE);

        //初始化图书数据
        List<Book> bookList = new ArrayList<>();
        bookList.add(new Book(1, "演员的自我修养", "斯坦尼斯拉夫斯基", Constant.TYPE_COMPUTER, "24-7", "斯蒂芬周出版社", Constant.STATUS_STORAGE));
        bookList.add(new Book(2, "我爱祖国天安门", "劳动人民", Constant.TYPE_LITERATURE, "24-13", "大中国出版社", Constant.STATUS_STORAGE));
        bookList.add(new Book(3, "万里长城永不倒", "劳动人民", Constant.TYPE_MANAGEMENT, "24-30", "大中国出版社", Constant.STATUS_STORAGE));
        bookList.add(new Book(4, "阿门阿门阿阿门", "耶稣", Constant.TYPE_ECONOMY, "110-1", "国际出版社", Constant.STATUS_STORAGE));
        bookList.add(new Book(5, "21天精通划水摸鱼 ", "葛大爷", Constant.TYPE_LITERATURE, "24-7", "躺平出版社", Constant.STATUS_STORAGE));
        bookList.add(new Book(6, "有效治疗腰椎间盘突出的21个民间偏方", "程序猿", Constant.TYPE_COMPUTER, "0-0-7", "1024出版社", Constant.STATUS_STORAGE));
        bookList.add(new Book(7, "从入门到入土（Java）", "程序猿", Constant.TYPE_ECONOMY, "110-1", "1024出版社", Constant.STATUS_STORAGE));
        bookList.add(new Book(8, "从入门到入土（Python）", "程序猿", Constant.TYPE_ECONOMY, "110-2", "1024出版社", Constant.STATUS_STORAGE));
